...
<aside id="minileftbar" class="minileftbar">
    <ul class="menu_list">
        <li>
            ...
            <a class="navbar-brand" href="index.html"><img src="{{asset('be/assets/images/logo.svg')}}" alt="Alpino"></a>
        </li>
                ...
                <div class="body">
                    <ul class="messages list-unstyled">
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object rounded-circle" src="{{asset('be/assets/images/xs/avatar1.jpg')}}" alt="">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object rounded-circle" src="{{asset('be/assets/images/xs/avatar2.jpg')}}" alt="">
                                    <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object rounded-circle" src="{{asset('be/assets/images/xs/avatar3.jpg')}}" alt="">
                                    <div class="media-body">
    ...
    <div id="leftsidebar" class="sidebar">
        <div class="menu">
            <ul class="list">
                ...
                <li class="header">Bidang, Cabang, Kategori, Majalah</li>   
                <li class="{{ Request::routeIs('page.master*') ? 'active' : '' }} sm_menu_btm"> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-copy"></i><span>Master Data</span> <span class="badge badge-default float-right"></span></a>
                    <ul class="ml-menu">
                        <li class="{{ Request::routeIs('page.master.kategori_page') ? 'active open' : '' }}"><a href="{{route('page.master.kategori_page')}}">Kategori</a></li>
                        ...
                        <li><a href="projects.html">Bidang</a></li>
